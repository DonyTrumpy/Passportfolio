...
<html lang="en" dir="ltr">
  <head>
    ...
    <style media="screen">
      #JoinMe{left:12%;}#Email{left:47%;}#Phone{left:47%;}
  ...
  <body>
    ...
    <div class="TreeWater" data-s-speed="200">
      <div class="Awesomeness" data-s-speed="1">
        ...
        <h3>Begleite mich auf meiner Reise</h3>
      ...
      <nav id="navbar">
      <img src="images/LogoPP.png" alt="Logo" id="Logo" onclick="window.location='../Passportfolio_de.html'">

            <a class="Ul" id="a1" href="#Passport">Meine Arbeiten</a>
            <a class="Ul" id="a2" href="#Aboutt">Fähigkeiten</a>
            <a class="Ul" id="a3" href="#Productss">Produkte</a>
            <a class="Ul" id="a4" href="#Contact">Kontakt</a>
  ...
  $('.PopPop').fadeOut();
    ...
    <div class="Passport" id="Passport" data-s-speed="6"></div>
              <div class="My" data-s-speed="32">
                ...
                <a class="col-11 col-lg-5 Web" id="W1" href="https://kinemap.be/home/home_de.php">
                  <div class="Weby" id="Weby1"><p><br><br><br>Finden Sie IHRE Kiné</p></div>
                </a>
                <a class="col-11 col-lg-5 Web" id="W2">
                <div class="Weby" id="Weby2">  <p><br><br>Sehen Sie sich an, <br>was Menschen konsumieren <br>und wie viel es kostet.</p></div>
              </a>
                <a class="col-5 col-lg-3 Web" id="W4">
                  <div class="Weby"><p><br><br>Beispiel für eine <br>Basisvorlage</p></div>
                </a>
                <a class="col-5 col-lg-3 Web" id="W5">
                  <div class="Weby"><p><br><br>Beispiel für eine <br>Basisvorlage</p></div>
                </a>
                <a class="col-5 col-lg-3 Web" id="W6">
                  <div class="Weby"><p><br><br>Beispiel für eine <br>Traditionelle Vorlage</p></div>
                </a>
                <a class="col-5 col-lg-3 Web" id="W7">
                  <div class="Weby" id="Weby7"><p><br><br>Beispiel für eine vollständig <br>personalisierte Website.</p></div>
                </a>
                <a class="col-5 col-lg-3 Web" id="W8">
                <div class="Weby">  <p><br>Holen Sie sich ein <br>vollständig zufälliges <br>und sicheres Passwort <br>mit den gewünschten Einstellungen!</p></div>
              </a>
                <a class="col-5 col-lg-3 Web" id="W9">
                  <div class="Weby" id="Weby9"><p><br><br>Überprüfen Sie, <br>ob es Kontrollen <br>auf Ihrer Leitung gibt.</p></div>
                </a>
              </div>
          <div class="Sea"></div>
    </div>
...
<div class="Beach" data-s-speed="6">
        <div id="About">
        <div class="container">
          <p><br>Warum ich? Weil ich bin <span class="typed-text"></span><span class="cursor">&nbsp;</span></p>
        </div>
        <div class="Skills">
...
<div class="Extra" id="APIII"><img src="https://img.icons8.com/external-becris-flat-becris/48/000000/external-api-fintech-becris-flat-becris.png"/><p id="SKAPI">API Integration</p></div>
  ...
  <div class="Extra" id="APIII"><img src="https://img.icons8.com/external-becris-flat-becris/48/000000/external-api-fintech-becris-flat-becris.png"/><p id="SKAPI">API Integration</p></div>
    ...
    <div class="Click"> <h4 class="d-none d-xl-block">Nimm ein Stück Kuchen</h4> <p>Eine Website besteht wie ein Kuchen <br> aus mehreren Schichten.</p> </div>
      ...
      const textArray = ["Kreativ.", "Flexibel.", "Unabhängig.", "Hart arbeitend."];
...
<p>
"Codesüchtig. Kann nicht aufhören. In der Hoffnung, nie geheilt zu werden."
 </p>
 </div>
 <div class="col-sm-4 Quo" id="Quo2">
<p>
„Ich habe nichts Neues erfunden. Ich habe einfach die Entdeckungen anderer Menschen zusammengetragen, hinter denen Jahrhunderte der Arbeit stecken. Hätte ich fünfzig oder zehn oder sogar fünf Jahre zuvor gearbeitet, wäre ich gescheitert. So ist es mit jeder neuen Sache die Faktoren, die dafür verantwortlich sind, sind bereit, und dann ist es unvermeidlich. Zu lehren, dass verhältnismäßig wenige Männer für die größten Fortschritte der Menschheit verantwortlich sind, ist der schlimmste Unsinn." ~Henry Ford
</p>
</div>
</section>
  </div>
...
<h1 id="Prod">Produkte</h1>
    <div class="Propro col-5 col-lg-3" id="BasicT"><h2 id="PB">Basic Website</h2>  <div class="Hodor" id="HBT"><p><br><br>Wählen Sie aus verschiedenen Vorlagen aus, um eine ONE-Page-Website zu erhalten!<br><br>&emsp;&emsp;&emsp;~499€ </p></div> </div>
    <div class="Propro col-5 col-lg-3" id="ProT"><h2 id="PT">Traditional Website</h2> <div class="Hodor" id="HPT"><p><br><br>Wählen Sie aus mehreren Optionen, um eine Website mit MEHREREN Seiten zu erhalten!<br><br>&emsp;&emsp;&emsp;~799€</p></div></div>
    <div class="Propro col-5 col-lg-3" id="PersoT"><h2 id="PP">Pro Website</h2> <div class="Hodor" id="HPerT"><p><br><br>Erhalten Sie eine vollständig personalisierte Website mit einer vollständigen Anleitung!<br><br>&emsp;&emsp;&emsp;~1299€</p></div></div>
    <div class="Propro col-5 col-lg-3" id="API"><h2 id="PA">API</h2> <div class="Hodor" id="HAPI"><p><br><br>Integrieren Sie eine API<br><br>&emsp;&emsp;&emsp;~499€</p></div></div>
    <div class="Propro col-5 col-lg-3" id="MapI"><h2 id="PM">Map</h2> <div class="Hodor" id="HMI"><p><br><br>Integrieren Sie eine Karte<br><br>&emsp;&emsp;&emsp;~499€</p></div></div>
    <div class="Propro col-5 col-lg-3" id="SEO"><h2 id="PS">SEO</h2> <div class="Hodor" id="HSEO"><p><br><br>Stellen Sie Ihre Website bei Google höher ein<br><br>&emsp;&emsp;&emsp;~699€ </p></div></div>
</div>
  ...
  <div class="FormBox">
      <form method="post">
          ...
          <div class="InputBox">
              ...
              <span class="spann">Ihre Nachricht</span>
          </div>
